...
<html>
  ...
  <link rel="stylesheet" href="rosterstyle.css">
...
<div class="container-fluid bg-1"></br></br>
   ...
   <div class="team">
		<center><p><font color="white" size="10rem">Purple Team</font></p></center>
   </div>
   <div class="wrapper">
		<ul class="stage">
			<li class="scene">
		<div class="movie">
			<div class="poster" style="background-image: url(sean.jpg);"></div>
			<div class="info">
			<header style="background-image: url(league.png);	background-size: 100%;">
				<h1>Team Captain</h1>
			</header>
			<p>
				Kevin Magee <br></br> GT: daboomboom22 <br></br> Year: Freshmen <br></br> Major: Computation Science  
			</p>
			</div>
		</div>
	</li>	
	...
	<div class="team">
		<center><p><font color="white" size="10rem">Gold Team</font></p></center>
    </div>
	...
	<div class="team">
		<center><p><font color="white" size="10rem">Substitutes</font></p></center>
    </div>
